...
# Change 6: warn the answering model that unusual OCR words are uncertain
# evidence rather than automatically valid names, places, or terms.
...
قد تكون الكلمات النادرة أو غير المعتادة أو الغريبة سياقيًا في النص المسترجع
أخطاءً في التعرف على الكتابة اليدوية وليست أسماء أو أماكن أو مصطلحات حقيقية؛
لذلك تعامل معها بحذر إضافي ولا تبنِ عليها استنتاجات واقعية جازمة.
